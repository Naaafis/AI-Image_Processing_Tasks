...
def generate_clearer_image(input_image_path, output_folder):
    ...
    output_image_path = output_folder / (input_image_path.stem + "_deblurred" + input_image_path.suffix)
...
input_folder_path = Path("/Users/cheffbcookin/Desktop/EC520/AI-Image_Processing_Tasks/BlurredImages/Blur_3x3")
