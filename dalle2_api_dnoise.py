...
def generate_denoised_image(input_image_path, output_folder):
    ...
    response = client.images.edit(
        ...
        prompt="Denoise this image to remove gaussian noise. The output image should have a resolution of 512x512. The output image should be free of any noisy visual artifacts and should look like a clean version of the input image."
        n=1,
        size="512x512"
    )
